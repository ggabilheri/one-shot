...
import 'package:oneshot_server/src/data/repositories_impl/company_repositories.dart';
...
class Injections {
  ...
  late final ICompanyRepository companyRepository;
  ...
  late final ISubscriptionPlanRepository subscriptionPlanRepository;
