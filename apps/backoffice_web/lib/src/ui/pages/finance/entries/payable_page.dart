  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.money_off_outlined, size: 64, color: DSTokens.outline),
          const SizedBox(height: 16),
          Text('Nenhum lançamento a pagar encontrado.', style: DSTokens.body),
        ],
      ),
    );
  }
            ...
            Column(
              ...
              children: [
                Text(
                  ...
                  style: DSTokens.h2.copyWith(color: DSTokens.highlight, fontSize: 18),
                ),
                const SizedBox(height: 4),
                Row(
                  children: [
                    if (!isPaid)
                      IconButton(
                        ...
                        onPressed: () => vm.markAsPaid(entry, FinancialEntryType.payable),
